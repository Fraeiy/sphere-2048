-- Fix: deduct_move_credit failed with PostgreSQL error 42702
-- "column reference credits_remaining is ambiguous"
-- RETURNS TABLE output names conflicted with UPDATE ... RETURNING INTO.
